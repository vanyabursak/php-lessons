...
echo strstr($string,"e") . "</br>";//возращает участок строки после елемента
echo substr_count($string,"x" . "</br>");//сколько символов в строке
...
//минимальное число символов, которое требовалось бы заменить, вставить или удалить для того, чтобы превратить строку str1 в str2.